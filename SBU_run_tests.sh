...
python3 src/run_protocol.py IRN_joint_stream_att3 configs/SBU/IRN_joint_stream_att.cfg SBU -n 3
python3 src/run_protocol.py IRN_temporal_stream_att3 configs/SBU/IRN_temporal_stream_att.cfg SBU -n 3
python3 src/run_protocol.py IRN_two_stream_att3 configs/SBU/IRN_two_stream_att.cfg SBU -F middle -n 3
python3 src/run_protocol.py IRN_two_stream_att_avg3 configs/SBU/IRN_two_stream_att_avg.cfg SBU -F middle -n 3

python3 src/run_protocol.py IRN_joint_stream_att_no_rel3 configs/SBU/IRN_joint_stream_att_no_rel.cfg SBU -n 3
python3 src/run_protocol.py IRN_temporal_stream_att_no_rel3 configs/SBU/IRN_temporal_stream_att_no_rel.cfg SBU -n 3
python3 src/run_protocol.py IRN_two_stream_att_no_rel3 configs/SBU/IRN_two_stream_att_no_rel.cfg SBU -F middle -n 3
python3 src/run_protocol.py IRN_two_stream_att_no_rel_avg3 configs/SBU/IRN_two_stream_att_no_rel_avg.cfg SBU -F middle -n 3
