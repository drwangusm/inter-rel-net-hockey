            ...
            for file in files:
                if file == "summary.csv" and "fold_" in subdir:
                    ...
                    with open(os.path.join(subdir, file)) as summary:
                        ...
                        val_acc_mean.append(np.array(val_acc).astype(np.float64).mean())
                        val_acc_std.append(np.array(val_acc).astype(np.float64).std())
                        val_recall_mean.append(np.array(val_recall).astype(np.float64).mean())
                        val_recall_std.append(np.array(val_recall).astype(np.float64).std())
                        val_precision_mean.append(np.array(val_precision).astype(np.float64).mean())
                        val_precision_std.append(np.array(val_precision).astype(np.float64).std())
                        val_f1_mean.append(np.array(val_f1).astype(np.float64).mean())
                        val_f1_std.append(np.array(val_f1).astype(np.float64).std())
