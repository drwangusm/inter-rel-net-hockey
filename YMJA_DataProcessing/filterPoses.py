...
DP10_OPENPOSE_RESULTS_FOLDER = "output_json/"
DP10_OUTPUT_FOLDER = "FilteredPoses/"
DP10_TRIMMED_FOLDER = "clips_trimmed/"
...
if __name__ == '__main__':
    ...
    while clipIdx < len(filePaths):
        ...
        while(cap.isOpened()):
            ...
            #Read in JSON file
            with open(DP10_OPENPOSE_RESULTS_FOLDER + clipName+'/'+clipName.split('/')[1]+'_'+str(frameNum).zfill(12) + '_keypoints.json') as f:
